<template>
  <div class="p-5 flex flex-col bg-white w-full h-auto">
    ...
    <div class="w-full flex justify-center pt-5 pb-2">
      <nav>
        <a class="p-2 hover:text-pink-700" href="#">Лучшие</a>
        <a class="p-2 hover:text-pink-700" href="#">Последние</a>
        <a class="p-2 hover:text-pink-700" href="#">Все</a>
        <a class="p-2 hover:text-pink-700" href="#">О нас</a>
      </nav>
    </div>
    <!-- links --- end -->
    <!-- social --- start -->
